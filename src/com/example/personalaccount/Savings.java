...
public class Savings extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String sql2="create table if not exists SAVINGS(date varchar,source varchar,amount int); ";//create Expense table
		//DB.execSQL(sql1);
		DB.execSQL(sql2);
		...
		btSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				int Amount,Ramount;
				 ...
				 if(Amount==Ramount)
				 {
					 String sql3="insert into SAVINGS values('"+Date+"','"+Source+"',"+Amount+");";
					 DB.execSQL(sql3);
   ...
   public boolean onOptionsItemSelected(MenuItem item)
   {
      ...
      // case R.id.menu_income:
          ...
          // return true;
       case R.id.iitem1:
       	Intent income=new Intent(Savings.this,Income.class);
			startActivity(income);
			 return true;
       case R.id.iitem2:
       	Intent ireport=new Intent(Savings.this,View_income.class);
			startActivity(ireport);
			 return true;
       case R.id.iitem3:
       	Intent Mreport=new Intent(Savings.this,M_report_Income.class);
			startActivity(Mreport);
			 ...
			 // case R.id.menu_Bank:
		          ...
		          // return true;
       case R.id.bitem1:
          	Intent saving=new Intent(Savings.this,Savings.class);
   			startActivity(saving);
   			 return true;
          case R.id.bitem2:
          	Intent ireport1=new Intent(Savings.this,View_bank_savings.class);
   			startActivity(ireport1);
   			 return true;
          case R.id.bitem3:
          	Intent Mreport1=new Intent(Savings.this,M_report_Income.class);
       ...
       //case R.id.menu_expense:
          ...
          // return true;
       case R.id.eitem1:
       	Intent exp=new Intent(Savings.this,Expense.class);
			startActivity(exp);
			 return true;
       case R.id.eitem2:
       	Intent ereport=new Intent(Savings.this,View_expense.class);
			startActivity(ereport);
           return true;
       case R.id.eitem3:
       	Intent eMreport=new Intent(Savings.this,M_report.class);
			startActivity(eMreport);
           return true;
       case R.id.menu_about:
       	Intent v=new Intent(Savings.this,About.class);
			startActivity(v);
			 return true;

...
public class View_expense extends Activity{
	SQLiteDatabase DB; 
	 TextView tv;
	 Button btSE;
	 ListView list;
...
//	ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, R.layout.view_data,arrayList);
	...
	ArrayAdapter<String> adapter = new ArrayAdapter<String>(View_expense.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
       ...
       // case R.id.menu_income:
           ...
           // return true;
        case R.id.iitem1:
        	Intent income=new Intent(View_expense.this,Income.class);
			startActivity(income);
			 return true;
        case R.id.iitem2:
        	Intent ireport=new Intent(View_expense.this,View_income.class);
			startActivity(ireport);
			 return true;
        case R.id.iitem3:
        	Intent Mreport=new Intent(View_expense.this,M_report_Income.class);
			startActivity(Mreport);
			 return true;
        case R.id.bitem1:
         	Intent saving=new Intent(View_expense.this,Savings.class);
        			startActivity(saving);
        			 return true;
         case R.id.bitem2:
         	Intent ireport1=new Intent(View_expense.this,View_bank_savings.class);
        			startActivity(ireport1);
        			 return true;
         case R.id.bitem3:
         	Intent Mreport1=new Intent(View_expense.this,M_report_Income.class);
        ...
        //case R.id.menu_expense:
           ...
           // return true;
        case R.id.eitem1:
        	Intent exp=new Intent(View_expense.this,Expense.class);
			startActivity(exp);
			 return true;
        case R.id.eitem2:
        	Intent ereport=new Intent(View_expense.this,View_expense.class);
			startActivity(ereport);
            return true;
        case R.id.eitem3:
        	Intent eMreport=new Intent(View_expense.this,M_report.class);
			startActivity(eMreport);
            return true;
        case R.id.menu_about:
        	Intent v=new Intent(View_expense.this,About.class);
			startActivity(v);
			 return true;

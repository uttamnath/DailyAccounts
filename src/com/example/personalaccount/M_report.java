...
public class M_report extends Activity{
			...
			public void onClick(View arg0) {
				...
				try{
					...
					ArrayList<String> arrayList = new ArrayList<String>();
				     ...
				     String sql = "select *from EXPENSE where date BETWEEN '"+ from + "' AND '" + to + "';";
					...
					do
					{
						...
						detl=c.getString(c.getColumnIndex("details"));
					...
					tot="Total Expense="+String.valueOf(total)+"Taka";
					arrayList.add(tot);
					
		
			ArrayAdapter<String> adapter = new ArrayAdapter<String>(M_report.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
       ...
       // case R.id.menu_income:
           ...
           // return true;
        case R.id.iitem1:
        	Intent income=new Intent(M_report.this,Income.class);
			startActivity(income);
			 return true;
        case R.id.iitem2:
        	Intent ireport=new Intent(M_report.this,View_income.class);
			startActivity(ireport);
			 return true;
        case R.id.iitem3:
        	Intent Mreport=new Intent(M_report.this,M_report_Income.class);
			startActivity(Mreport);
			 return true;
        case R.id.bitem1:
         	Intent saving=new Intent(M_report.this,Savings.class);
        			startActivity(saving);
        			 return true;
         case R.id.bitem2:
         	Intent ireport1=new Intent(M_report.this,View_bank_savings.class);
        			startActivity(ireport1);
        			 return true;
         case R.id.bitem3:
         	Intent Mreport1=new Intent(M_report.this,M_report_Income.class);
        ...
        //case R.id.menu_expense:
           ...
           // return true;
        case R.id.eitem1:
        	Intent exp=new Intent(M_report.this,Expense.class);
			startActivity(exp);
			 return true;
        case R.id.eitem2:
        	Intent ereport=new Intent(M_report.this,View_expense.class);
			startActivity(ereport);
            return true;
        case R.id.eitem3:
        	Intent eMreport=new Intent(M_report.this,M_report.class);
			startActivity(eMreport);
            return true;
        case R.id.menu_about:
        	Intent v=new Intent(M_report.this,About.class);
			startActivity(v);
			 return true;
